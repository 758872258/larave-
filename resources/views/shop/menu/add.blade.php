...
@section("content")
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control"  name="month_sales" >
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control"  name="satisfy_count" >
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">满意度评分</label>
            <div class="col-sm-10">
                <input type="text" class="form-control"  name="satisfy_rate" >
            </div>
        </div>
        <div class="form-group">
